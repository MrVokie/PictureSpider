...
//        _actionButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemOrganize target:self action:@selector(actionButtonPressed:)];
        UIImage *actionImage = [UIImage imageNamed:@"download"];
        _actionButton = [[UIBarButtonItem alloc]initWithImage:actionImage style:UIBarButtonItemStylePlain target:self action:@selector(actionButtonPressed:)];
    }
